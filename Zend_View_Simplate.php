...
// METHODS FROM THE INTERFACE
     ...
     * @param string The directoryto set as the path. Note that
     * @return $this
     */
    ...
    /**
     * Processes a view script and returns the output in html.
    ...
    /**
     * unsused methods but are set in the interface
     * @param type $path
     * @param type $classPrefix 
     */
